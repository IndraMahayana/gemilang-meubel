                    ...
                    <ul>
                        <li>
                            <x-button
                                ...
                                +6281237205111</x-button>
                        </li>
                        <li>
                            <x-button
                                href="#gemilangmeubel.electronic@gmail.com"
                                variant="transparent"><svg
                                    class="w-6 h-6 mr-2 text-gray-800 dark:text-white" aria-hidden="true"
                                ...
                                gemilangmeubel.electronic@gmail.com</x-button>
                        </li>
                    </ul>
                </div>
                <div class="w-1/3">
                    ...
                    <ul>
                        <li>
                            <x-button class="mt-4 mb-2" href="#081913967305" variant="transparent"><svg
                                    class="w-6 h-6 mr-2 text-gray-800 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                    <path fill="currentColor" fill-rule="evenodd"
                                ...
                                gemilangmeubel</x-button>
                        </li>
                        <li>
                            <x-button href="#gemilangmeubel.electronic@gmail.com" variant="transparent"><svg
                                    class="w-6 h-6 mr-2 text-gray-800 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                    viewBox="0 0 24 24">
