    ...
    <div class=" flex flex-wrap items-center justify-between px-20 p-4">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
            <ul
                ...
                <li>
                    <a href="{{ route('about') }}"
                        class="block py-2 px-3 md:p-0 rounded-sm {{ Route::currentRouteName() === 'about' ? 'text-blue-600' : 'text-gray-900' }}">About</a>
                </li>
                <li>
                    <a href="{{ route('products') }}"
                        class="block py-2 px-3 md:p-0 rounded-sm {{ Route::currentRouteName() === 'products' ? 'text-blue-600' : 'text-gray-900' }}">Product</a>
                </li>
                <li>
                    <a href="{{ route('contact') }}"
                        class="block py-2 px-3 md:p-0 rounded-sm {{ Route::currentRouteName() === 'contact' ? 'text-blue-600' : 'text-gray-900' }}">Contact</a>
                </li>
            </ul>
        </div>
    </div>
